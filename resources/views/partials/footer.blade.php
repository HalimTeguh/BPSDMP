<footer id="footer" class="footer">
      ...
      <div class="container">
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
            <h4>Contact Us</h4>
            <p>
              Jl. Raya Ketajen No.36, Ketajen, Kec. Gedangan <br />
              Kabupaten Sidoarjo, Jawa Timur 61254<br />
              Indonesia <br /><br />
              <strong>Phone:</strong> (031) 8011944<br />
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>BPSDMP Kominfo Surabaya x Halim Teguh Saputro</span></strong
        >. All Rights Reserved
      </div>
    </div>
  </footer>
